<div class="wrap" id="of_container">
	...
	<div id="of-popup-save" class="of-save-popup">
		<div class="of-save-save">Lưu thành công</div>
	</div>
	
	<div id="of-popup-reset" class="of-save-popup">
		<div class="of-save-reset">Khôi phục cài đặt gốc</div>
	</div>
	
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-save-fail">Lưu không thành công!</div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div class="save_bar"> 
			...
			<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Khôi phục cài đặt gốc');?></button>
...
<div class="smof_footer_info">© 2014 Lindo. All Rights Reserved. Một sản phẩm của Lindo. <strong><?php echo SMOF_VERSION; ?></strong></div>