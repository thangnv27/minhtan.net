...
function optionsframework_add_admin() {
		...
		$icon = get_template_directory_uri().'/admin/assets/images/general.png';

$of_page = 
 
 add_menu_page( THEMENAME, 'Themes Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',$icon);
add_submenu_page( 'optionsframework', 'Themes Settings', 'Themes Settings', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
add_submenu_page( 'optionsframework', 'Documentation', 'Documentation', 'edit_theme_options', 'docs', 'f_documentation');

	function f_documentation(){
		 $docs_url="http://mauwebsitedep.com/huong-dan-su-dung/";
