...
function lifeweb_breadcrumbs() {
  ...
  if ( !is_home() && !is_front_page() || is_paged() ) {
    ...
    global $post;
    $homeLink = home_url();
    echo '<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" class="crumbs-home" href="' . $homeLink . '">' . __( '<i class="fa fa-home"></i> Trang chủ' , 'tie' ) . '</a></span> ' . $delimiter . ' ';
